...
namespace CoreSolution.Application.Catalog.Products
{
    ...
    {
        Task<PagedResult<ProductViewModel>> GetAllPaging(string languageId, ProductGetAllPagingRequest request);
    }
    ...
    public class PublicProductService : IPublicProductService
    {
        ...
        public PublicProductService(CoreDbContext coreDbContext, IStorageService iStorageService)
        {
            _context = coreDbContext;
            _iStorageService = iStorageService;
        }

        public async Task<PagedResult<ProductViewModel>> GetAllPaging(string languageId, ProductGetAllPagingRequest request)
        { 
            //1. Select join
